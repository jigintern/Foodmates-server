...
func InitTables(db2 *gorm.DB) {
	...
	tx.Exec("INSERT INTO `Users` (`id`, `login_name`, `name`, `created_at`, `updated_at`, `biography`, `birth`, `country`, `prefecture`, `icon_address`)VALUES(1, 'yamada', 'やまだ', '2019-09-04 04:44:38', '2019-09-05 05:13:50', 'jig.jp エンジニア', '1980-02-03', 'Japan', 'Fukui', '/uploads/icons/yamada.jpg'),(2, 'demi', 'でみ', '2019-09-04 04:44:38', '2019-09-05 05:13:52', 'まいづるこーせん', '1980-02-03', 'Japan', 'Kyoto', '/uploads/icons/demi.jpg'),(3, 'watano', 'watano', '2019-09-04 04:44:38', '2019-09-05 05:13:56', 'いばらきこーせん', '1980-02-03', 'Japan', 'Ibaraki', '/uploads/icons/watano.jpg'),(4, 'hatahata', 'はたはた', '2019-09-04 04:44:38', '2019-09-05 05:13:59', 'つやまこーせん', '1980-02-03', 'Japan', 'Okayama', '/uploads/icons/hatahata.jpg'),(5, 'houmori', '箒コウモリ', '2019-09-04 04:44:38', '2019-09-05 05:14:02', 'かがわこーせんたかまつきゃんぱす', '1980-02-03', 'Japan', 'Kagawa', '/uploads/icons/houmori.jpg');")
