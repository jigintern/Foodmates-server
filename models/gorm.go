...
func InitTables(db2 *gorm.DB) {
	...
	tx.Exec("INSERT INTO `Users` (`id`, `name`, `created_at`, `updated_at`, `biography`, `birth`, `country`, `prefecture`, `icon_address`)VALUES(1, 'やまだ', '2019-09-04 04:44:38', '2019-09-04 08:11:17', 'jig.jp エンジニア', '1980-02-03', 'Japan', 'Fukui', '/uploads/icons/yamada.jpg'),(2, 'でみ', '2019-09-04 04:44:38', '2019-09-04 08:10:26', 'まいづるこーせん', '1980-02-03', 'Japan', 'Kyoto', '/uploads/icons/demi.jpg'),(3, 'watano', '2019-09-04 04:44:38', '2019-09-04 08:11:10', 'いばらきこーせん', '1980-02-03', 'Japan', 'Ibaraki', '/uploads/icons/watano.jpg'),(4, 'はたはた', '2019-09-04 04:44:38', '2019-09-04 08:10:38', 'つやまこーせん', '1980-02-03', 'Japan', 'Okayama', '/uploads/icons/hatahata.jpg'),(5, '箒コウモリ', '2019-09-04 04:44:38', '2019-09-04 08:10:59', 'かがわこーせんたかまつきゃんぱす', '1980-02-03', 'Japan', 'Kagawa', '/uploads/icons/houmori.jpg');")
	if tx.Error != nil {
