...
func InitTables(db2 *gorm.DB) {
	...
	tx.Exec("INSERT INTO `Posts` (`id`, `user_id`, `created_at`, `updated_at`, `dish_id`, `comment`, `image_address`)VALUES(1, 1, '2019-08-29 05:01:31', '2019-08-29 05:26:10', 4, 'hogehoge', 'img/dishes/42.jpg'),(7, 2, '2019-08-29 17:12:03', '2019-08-30 00:33:21', 4, 'it was delicious!', ''),(8, 2, '2019-08-29 17:12:03', '2019-08-30 00:51:55', 1, '', ''),(9, 2, '2019-08-29 17:12:03', '2019-08-30 00:54:23', 3, NULL, 'img/gazou/abc/123.jpg');")
